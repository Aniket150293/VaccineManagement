...
export default function Form1({
    getCompany,
    getcompanysuccess,
    getVcount, getVcountsuccess, submitRegisteredUserSucsses, submitRegisteredUser
}) {
                        ...
                        <Row>
                            <div class="form-check form-check-inline">
                                <Form.Group as={Col} lg="4">
                                    ...
                                    />
                                    <label class="form-check-label" for="inlineRadio1" value={gender}>Male</label>
                                    {validateMsgValid}
                                    {validateMsgInvalid}
                                </Form.Group>
                                {validateMsgValid}
                                ...
                                <Form.Group as={Col} lg="4">
                                    <Input
                                        ...
                                        onChange={(e) => setGender(e.target.value)}
                                    />
                                    <label class="form-check-label" for="inlineRadio2" value={gender}>FeMale</label>
                                    {validateMsgValid}
                                    {validateMsgInvalid}
                                </Form.Group>
                                {validateMsgValid}
                                ...
                                <Form.Group as={Col} lg="4">
                                    <Input
                                        ...
                                        onChange={(e) => setGender(e.target.value)}
                                    />
                                    <label class="form-check-label" for="inlineRadio3" value={gender}>other</label>
                                    {validateMsgValid}
                                    {validateMsgInvalid}
                                </Form.Group>
                                {validateMsgValid}
